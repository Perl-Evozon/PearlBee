...
__PACKAGE__->add_columns(
  ...
  "role",
  { data_type => "text", default_value => "author", is_nullable => 0 },
  "activation_key",
  {
    data_type => "varchar",
    default_value => \"null",
  ...
  "status",
  { data_type => "text", default_value => "deactivated", is_nullable => 0 },
  "salt",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:At7WuCYDyjnEZz9kv/PU3Q
