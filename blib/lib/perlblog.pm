...
# Common controllers
use perlblog::Authentication;
use perlblog::Authorization;
use perlblog::Dashboard;

# Admin controllers
use perlblog::Admin::Category;
use perlblog::Admin::Tag;
use perlblog::Admin::Post;
use perlblog::Admin::Comment;
use perlblog::Admin::User;

# Author controllers
use perlblog::Author::Post;
use perlblog::Author::Comment;
